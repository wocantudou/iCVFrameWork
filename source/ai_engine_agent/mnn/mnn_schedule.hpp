...
class AIEngineSchedule {
  ...
  public:
    ...
    int32_t ai_engine_destory_impl(DNNModelHandle &model_handle) {
        int32_t ret = ICVBASE_NO_ERROR;
        if (model_handle) {
    ...
    int32_t ai_inst_create_impl(DNNModelHandle &model_handle,
    ...
    int32_t ai_inst_destroy_impl(DNNModelHandle &model_handle,
                                 DNNExecuteHandle &execute_handle) {
        int32_t ret = ICVBASE_NO_ERROR;
        if (execute_handle) {
            bool flag =
    ...
    int32_t ai_io_data_prepares_impl(DNNModelHandle &model_handle,
                                     DNNExecuteHandle &execute_handle,
                                     DnnDataIO &data_io) {
        int32_t ret = ICVBASE_NO_ERROR;
        // input prepares{
    ...
    int32_t ai_run_impl(DNNModelHandle &model_handle,
                        DNNExecuteHandle &execute_handle, DnnDataIO &data_io) {
        int32_t ret = ICVBASE_NO_ERROR;
        // set input
        auto input_tensors =
            model_handle->net_->getSessionInputAll(execute_handle->session_);
